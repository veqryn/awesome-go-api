...
Respond with a greeting
 ...
 @return ApiGreetingRequest
*/
func (a *GreetingsAPIService) Greeting(ctx context.Context, name string) ApiGreetingRequest {
	return ApiGreetingRequest{
		ApiService: a,
		ctx: ctx,
		name: name,
...
//  @return GetGreetingOutputBody
func (a *GreetingsAPIService) GreetingExecute(r ApiGreetingRequest) (*GetGreetingOutputBody, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GreetingsAPIService.Greeting")
	if err != nil {
